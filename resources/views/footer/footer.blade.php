...
<footer class="text-center text-lg-start bg-body-tertiary text-muted" style="border: 3px solid black; padding: 1rem 0;">
    ...
    <div class="text-center p-2" style="background-color: rgba(0, 0, 0, 0.05);">
        ...
        <a class="text-reset fw-bold" href="#">Developers</a>
      </div>
